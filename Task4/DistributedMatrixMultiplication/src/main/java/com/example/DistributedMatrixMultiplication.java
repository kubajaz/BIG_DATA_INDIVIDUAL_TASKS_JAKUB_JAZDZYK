...
public class DistributedMatrixMultiplication {
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        config.getNetworkConfig().getJoin().getMulticastConfig().setEnabled(false); // wyłącz multicast
        config.getNetworkConfig().getJoin().getTcpIpConfig().setEnabled(true).addMember("192.168.1.194").addMember("192.168.1.253");
